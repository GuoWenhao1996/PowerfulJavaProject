...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/PhoneBookMS/css/index.css" />
	<style type="text/css">
		.logo{
			height: 90px;
			position: absolute;
	...
	<div data-options="region:'west',title:'导航栏',iconCls:'icon-nav'"
		...
		<div id="menu" class="easyui-accordion" data-options="fit:true">
			<div title="好友管理" data-options="iconCls:'icon-friend'">
				<ul>
					<li name="/PhoneBookMS/jsp/addFriend.jsp">添加好友</li>
					<li name="/PhoneBookMS/jsp/none.jsp">删除好友</li>
					<li name="/PhoneBookMS/jsp/none.jsp">修改好友</li>
					<li name="/PhoneBookMS/queryAllFriend">查询好友</li>
				</ul>
			</div>
			<div title="个人信息管理" data-options="iconCls:'icon-selfInfo'">
				<ul>
					<li name="/PhoneBookMS/jsp/none.jsp">查看信息</li>
					<li name="/PhoneBookMS/jsp/none.jsp">修改信息</li>
				</ul>
			</div>
			<div title="系统安全" data-options="iconCls:'icon-safe'">
				<ul>
					<li name="/PhoneBookMS/jsp/none.jsp">修改密码</li>
					<a href="/PhoneBookMS/logout"><li>退出登录</li></a>
				</ul>
			</div>
		</div>
		<!--此行以上为导航菜单-->

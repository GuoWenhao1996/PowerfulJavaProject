...
<script src="/PhoneBookMS/js/jquery-1.11.0.min.js" type="text/javascript" charset="utf-8"></script>
<script src="/PhoneBookMS/js/bootstrap.min.js" type="text/javascript" charset="utf-8"></script>
<script src="/PhoneBookMS/js/jquery.validate.js" type="text/javascript" charset="utf-8"></script>
<style type="text/css">
.errLabel {
	font-size: 10px;
	color: red;
	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<form id="form" action="/PhoneBookMS/reg" method="post"
					...
					<div class="col-md-6 col-md-offset-3" style="margin-top: 20px; font-size: 16px;">
						...
						<a href="/PhoneBookMS/login.jsp">已有账号？点我登录！</a>
					</div>
				</form>

...
<body>
	...
	$('#dg').datagrid({    
	    ...
	    columns:[[  
	        ...
	        {field:'schoolid',title:'流派编号',width:100,align:'center'},    
	        {field:'schoolname',title:'流派名称',width:100,align:'center'},    
	        {field:'schooltext',title:'流派描述',width:100,align:'center'}, 
	        {field:'schoolstate',title:'流派状态',width:100,align:'center'}
	    ]] ,
		toolbar: [{
			text:'增加',
			iconCls: 'icon-add',

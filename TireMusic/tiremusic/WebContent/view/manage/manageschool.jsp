...
<body>
	...
	<div id="win_1">
		<form action="">
			流派名称：<input type="text" name="schoolname"/><br/>
			流派介绍：<textarea rows=3 cols=30 name="scooltext"></textarea><br/>
			<a id="btn_1" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'">添加流派</a>
		</form>
	</div>  
	<div id="win_2">
		<form action="">
			流派名称：<input type="text" name="schoolname"/><br/>
			流派介绍：<textarea rows=3 cols=30 name="scooltext"></textarea><br/>
			<a id="btn_1" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'">流派修改</a>
		</form>
	</div>  
	...
	//加载用户信息
	$('#dg').datagrid({    
	    url:'<%=basepath %>/school/loadAllSchools.do', 
	    rownumbers:true,
	    singleSelect:true,
	    pagination:true,
	    height:460,
	    ...
	    columns:[[
	    	{field:'schoolid',title:'',width:100,checkbox:true}, 
	        {field:'schoolname',title:'流派名称',width:200,align:'center'},    
	        {field:'schooltext',title:'流派介绍',width:200,align:'center'},    
	        {field:'schoolstate',title:'流派状态',width:200,align:'center'}
	    ]]    
	}); 
	//页面加载后查询流派
	$(function(){

	...
	<body style="background-color: #7bbfea;">
		...
		<script type="text/javascript">
			...
			function checkPassword() {
				...
				$.post("/sms/user/checkPassword.do",{oldpassword:oldpassword},function(data){
					if(data=='true'){
						$('#error').text("　");
						flag=true;
					}else{
			...
			function updatePassword(){
				if(flag){
					...
					$.post("/sms/user/updatepassword.do",{password:passwordA},function(data){
						if(data=='true'){
							location.href="/sms/view/login.jsp";	
						}else{
							$('#error').text(data);
						}
					},"text");

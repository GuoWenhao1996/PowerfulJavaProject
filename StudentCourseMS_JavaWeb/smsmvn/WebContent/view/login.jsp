...
<html>
	...
	<body style="background-color: #7bbfea;">
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<form action="<%=basePath%>/user/login.do" id="form" method="post" style="background-color: #afdfe4; width: 600px; height: 450px; margin: 130px auto 0px; border-radius: 20px;">
		...
		<script src="<%=basePath%>/js/jquery.validate.js" type="text/javascript" charset="utf-8"></script>
		<script src="<%=basePath%>/js/yzm.js" type="text/javascript" charset="utf-8"></script>
		<script src="<%=basePath%>/js/checkForm.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>
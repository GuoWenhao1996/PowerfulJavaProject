...
<body class="easyui-layout">   
    <div data-options="region:'north'" style="height:100px;">
    	<h1 align="center" style="font-size: 30px;color: #0081C2;">
    		<img id="logo" alt="logo" src="<%=basePath%>/img/main.png">	
    		中 软 国 际<sup>&reg;</sup>学 生 管 理 系 统&trade;<sub><small>书山有路勤为径-学海无涯苦作舟</small></sub>
    		<a id="logout" href="<%=basePath%>/user/logout.do" class="easyui-linkbutton" data-options="iconCls:'icon-logout',width:98,height:98"></a>
    	</h1> 
    </div>   
		    	...
		    	<div title="${menu.name}" data-options="iconCls:'icon-menu'" style="padding:10px;">   
					<ul>
						<c:forEach items="${menu.children}" var="childMenu">
							<a href="<%=basePath%>${childMenu.url}" target="centerFrame"><li>${childMenu.name}</li></a>
						</c:forEach>
					</ul>
		    	</div> 
			</c:forEach>    
